...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $ins_query = "INSERT INTO events (organizer_id, title, description, event_date, venue_name, venue_address, capacity, price, status, image_path) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt_ins = mysqli_prepare($conn, $ins_query);
    mysqli_stmt_bind_param($stmt_ins, "isssssidss", $orgId, $title, $description, $eventDateFormatted, $venueName, $venueAddress, $capacity, $price, $status, $imagePath);
    
    if (mysqli_stmt_execute($stmt_ins)) {
        header("Location: organizer-events.php?success=Event+created+successfully");
        exit();
    } else {
    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar">
            ...
            <ul class="nav-links">
                ...
                <li class="active"><a href="organizer-events-addNew.php"><i class="fas fa-plus-circle"></i> Create New Event</a></li>
        ...
        <main class="main-content">
            <header class="top-bar">
                <div class="page-title"><h1>Create New Event</h1></div>
                <div class="user-menu">
            ...
            <div class="content-padding">
                <div class="card card-padded">
                    ...
                    <form action="organizer-events-addNew.php" method="POST" enctype="multipart/form-data" class="admin-form">
                        <?php if ($error): ?>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-input" placeholder="e.g. Coding Workshop 2024" required>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-textarea" placeholder="Describe your event..."></textarea>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                <label>Total Ticket Capacity / Quantity <span>*</span></label>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="datetime-local" name="endDate" class="form-input">
                            </div>
                        </div>
