...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $up_query = "UPDATE events SET title = ?, description = ?, event_date = ?, venue_name = ?, venue_address = ?, capacity = ?, price = ?, status = ?, image_path = ? WHERE id = ? AND organizer_id = ?";
    $stmt_up = mysqli_prepare($conn, $up_query);
    mysqli_stmt_bind_param($stmt_up, "sssssidssii", $title, $description, $eventDateFormatted, $venueName, $venueAddress, $capacity, $price, $status, $imagePath, $eventId, $orgId);
    if (mysqli_stmt_execute($stmt_up)) {
        header("Location: organizer-events.php?success=Event+updated+successfully");
        exit();
    } else {
        ...
        <main class="main-content">
            ...
            <div class="content-padding">
                <div class="card card-padded">
                    ...
                    <form action="organizer-events-edit.php?id=<?php echo $eventId; ?>" method="POST" enctype="multipart/form-data" class="admin-form">
                        <?php if ($error): ?>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                <label>Total Ticket Capacity <span>*</span></label>
                        ...
                        <div class="form-actions">
                            <a href="organizer-events.php" class="btn-cancel">Cancel</a>
