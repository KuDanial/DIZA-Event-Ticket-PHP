            ...
            <div class="content-padding">
                <div class="card card-padded">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            <div class="view-label">Organizer</div>
                            <div class="view-value"><?php echo htmlspecialchars($event['company_name'] ?: ($event['first_name'] . ' ' . $event['last_name'])); ?> (#ORG-<?php echo $event['organizer_id']; ?>)</div>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            <div class="view-label">Total Capacity</div>
                            <div class="view-value"><?php echo htmlspecialchars($event['capacity']); ?> Tickets</div>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            <div class="view-label">Capacity</div>
                    ...
                    <div class="form-actions">
                        <a href="manage-events-edit.php?id=<?php echo $event['id']; ?>" class="btn-primary">
